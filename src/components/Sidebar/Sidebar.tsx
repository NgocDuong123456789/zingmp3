  ...
  return (
    <nav className='w-full h-[100vh] bg-[#221A2D] text-[white] relative'>
      ...
      <div className='mt-[15px]'>
        <Link to={path.home}>
          {' '}
          <div className={classnames('cursor-pointer flex items-center gap-3  py-3 ',{
        ...
        <div className=' cursor-pointer flex items-center gap-3  py-3 hover:bg-[#393142] hover:border-l-2 hover:border-[#9B4DE0]'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
      ...
      <div className=' cursor-pointer flex items-center gap-3  py-4  absolute bottom-0 border-t-2 border-[#393142] w-full'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='none'
          viewBox='0 0 24 24'
